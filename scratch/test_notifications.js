...
import { sendClinicRegistrationNotification, sendPharmacyRegistrationNotification } from '../backend/services/emailService.js';
...
async function testNotifications() {
    ...
    try {
        ...
        if (result) {
            ...
            console.log('❌ Clinic notification logic failed (Expected if EMAIL_PASS is missing).');
        }
    } catch (err) {
    ...
    try {
        ...
        if (result) {
            ...
            console.log('❌ Pharmacy notification logic failed (Expected if EMAIL_PASS is missing).');
        }
    } catch (err) {
