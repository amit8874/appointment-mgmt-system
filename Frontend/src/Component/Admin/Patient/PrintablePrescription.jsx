...
const PrintablePrescription = ({ 
  ...
  return (
    <div className="bg-white w-full max-w-[210mm] min-h-[297mm] mx-auto flex flex-col relative overflow-hidden shadow-2xl" style={{ backgroundColor: 'white', color: 'black' }}>
      ...
      <div className="bg-slate-100 px-8 py-3 flex items-center gap-6 text-[11px] border-b border-slate-200 print:bg-slate-100" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
