      ...
      content: (
        <div className="space-y-4 text-slate-600">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Liability:</strong> Oviaan Professional is not responsible for any actions taken based on AI-generated responses. AI can make mistakes.</li>
          </ul>
        </div>
      )
    },
    ...
    },
    {
      ...
      content: (
        <p className="text-slate-600 leading-relaxed">
          To the maximum extent permitted by law, Oviaan Professional shall not be 
      ...
      <section className="pt-32 pb-16 px-4 bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-500 font-medium max-w-2xl mx-auto">
            These terms govern your use of the Oviaan Professional platform and our AI-powered features.
          </p>
        </div>
      </section>
