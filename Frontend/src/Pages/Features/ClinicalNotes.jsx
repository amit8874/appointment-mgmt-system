...
const ClinicalNotes = () => {
  const benefits = [
    ...
    { title: "Ambient Recording", desc: "Automate your clinical documentation by allowing the Oviaan AI to scribe your patient encounters in real-time." },
  ...
  return (
    <FeatureLayout
      ...
      color="amber"
      benefits={benefits}
      aiHighlight="The Oviaan AI can predict the most likely diagnosis based on your notes and provide relevant medical literature or treatment guidlines."
    />
  );
};
